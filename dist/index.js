...
(function(root, factory) {
    ...
    return {
        ...
        getMimeTypeFromBase64: function(base64) {
            ...
            for (type in JSON) {
                signs = JSON[type].signs;
                mime = JSON[type].mime;
                for (sign of signs) {
                    [offset, magicNumber] = sign.split("\,");
                    offset = parseInt(offset);
                    magicNumber = hexToBase64(magicNumber);
                    if (base64.indexOf(magicNumber) === offset) {
                        return mime;
                    }
                }
            }
